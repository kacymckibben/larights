...
<head>
	...
	<title>Contáctenos | Ley de Inmigración | Los Ángeles, CA | L.A. Rights Law Office</title>
...
<body>
	<nav class="navbar navbar-fixed-top" role="navigation"> <!-- removed navbar-default -->
		<div class="navbar-header">
		    ...
		    <ul class="nav navbar-nav navbar-right">
				<li><a class="nav-link-espanol" style="display:none" href="contact.php"><button class="btn btn-espanol">Inglés</button></a></li>
			</ul>
		</div>
		<ul id="nav-link-espanol-desktop" class="nav navbar-nav navbar-right">
			<li><a class="nav-link-espanol" href="contact.php"><button class="btn btn-espanol">Inglés</button></a></li>
		</ul>
		<div class="navbar-collapse collapse navbar-right" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav navbar-left">
				...
				<li><a class="nav-link active" href="contáctenos.php">CONTÁCTENOS</a></li>
			</ul>
		</div>
	...
	<div class="container-fluid">
		<div class="row text-center">
			...
			<p>Llámenos o visítenos:</p>
		</div>
		<div class="row">
			<table id="contact-table">
				<tr>
					<td class="footer-label">TELÉFONO</td>
					<td>(310)906-0946</td>
				</tr>
				<tr>
					<td class="footer-label">HORAS</td>
					<td>Lunes - Viernes, 8 am - 5 pm</td>
				</tr>
				<tr>
					<td class="footer-label">DIRECCIÓN</td>
					<td>1320 West Gardena Blvd, Suite 203</td>
				</tr>
				<tr>
					<td></td>
		...
		<div class="row">
			<div class="col-sm-6 text-right">
				<div id="map" class="contact-map">
					<iframe class="actAsDiv" max-width="100%" height="262" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;q=1320%20West%20Gardena%20Blvd.%2C%20Suite%20203%20%E2%80%A2%20Gardena%2C%20CA%2090247&amp;aq=0&amp;ie=UTF8&amp;t=m&amp;z=14&amp;iwloc=A&amp;output=embed"></iframe>
				</div>
			</div>
			<div class="col-sm-6">
				<form id="ctaform" class="contact-form" method="post" action="contáctenos-form.php" onsubmit="validateForm();">
					<label class="label-white">NOMBRE</label><br>
					<input id="name" name="name"><br>
					<label class="label-white">EMAIL</label><br>
					<input id="email" name="email" type="email"><br>
					<label class="label-white">TELÉFONO</label><br>
					<input id="phone" name="phone" type="tel"><br>
					<label class="label-white">MENSAJE</label><br>
					<textarea id="message" rows="8" class="message" name="message" type="text"></textarea>
					<input id="submit" class="btn btn-form-dkblue" name="submit" type="submit" value="ENVIA">
				</form>
			</div>
		</div>
		<!--<div class="row reviews">
				...
				<div class="col-md-6 text-center">
					...
					<div class="row">
						<button class="btn" onclick="showDiv()">READ MORE</button>
						<div class="content">test Without hesitation I recommend Ms. Kuwahara’s services to family members, friends and to everyone in need of an excellent representation on immigration matters.test Without hesitation I recommend Ms. Kuwahara’s services to family members, friends and to everyone in need of an excellent representation on immigration matters.test Without hesitation I recommend Ms. Kuwahara’s services to family members, friends and to everyone in need of an excellent representation on immigration matters.”</div>
		    ...
		    <div class="row ctasmall">
				...
				<div class="col-md-4 text-center">
					<h4 class="white">Programe una cita llamando:</h4>
					<h2 class="phone white">310-906-0946</h2>
					<div class="or-container">
						<hr class="or-hr">
						<div id="or-grey">o</div>
					</div>
					<a href=""><button class="btn btn-cta">ENVIA UN MENSAJE</button></a>
				</div>
				<div class="col-md-4"></div>
		    </div>-->
		</div>
	...
	/*$(document).ready(function () {
		...
		$(".more-btn").click(function (event) {
			...
			/*var txt = $(".content").is(':visible') ? 'Read More' : 'Less';
			$(".more-btn").text(txt);
