...
<head>
	...
	<title>Contact | Immigration Law | Los Angeles, CA | L.A. Rights Law Office</title>
...
<body>
	<nav class="navbar navbar-fixed-top" role="navigation"> <!-- removed navbar-default -->
		<div class="navbar-header">
		    ...
		    <ul class="nav navbar-nav navbar-right">
				<li><a class="nav-link-espanol" style="display:none" href="contáctenos.html"><button class="btn btn-espanol">Español</button></a></li>
			</ul>
		</div>
		<ul id="nav-link-espanol-desktop" class="nav navbar-nav navbar-right">
			<li><a class="nav-link-espanol" href="contáctenos.html"><button class="btn btn-espanol">Español</button></a></li>
		</ul>
	...
	<div class="container-fluid">
		<div class="row text-center">
			...
			<p>Give us a call or visit us in person:</p>
		</div>
		<div class="row">
			<table id="contact-table">
				...
				<tr>
					<td class="footer-label">HOURS</td>
					<td>Mon - Fri, 8 am - 5 pm</td>
				</tr>
				<tr>
					<td class="footer-label">ADDRESS</td>
		...
		<div class="row">
			...
			<div class="col-sm-6">
				<form id="ctaform" class="contact-form" method="post" action="contact-form.php" onsubmit="validateForm();">
					<label class="label-white">NAME</label><br>
					<input id="name" name="name"><br>
					<label class="label-white">EMAIL</label><br>
					<input id="email" name="email" type="email"><br>
					<label class="label-white">PHONE</label><br>
					<input id="phone" name="phone" type="tel"><br>
					<label class="label-white">MESSAGE</label><br>
					<textarea id="message" rows="8" class="message" name="message" type="text"></textarea>
					<input id="submit" class="btn btn-form-dkblue" name="submit" type="submit" value="SEND">
				</form>
			</div>
		</div>
