	...
	<nav class="navbar navbar-fixed-top" role="navigation"> <!-- removed navbar-default -->
		<div class="navbar-header">
		    ...
		    <ul class="nav navbar-nav navbar-right">
				<li><a class="nav-link-espanol" style="display:none" href="inicio.php"><button class="btn btn-espanol">Español</button></a></li>
			</ul>
		</div>
		<ul id="nav-link-espanol-desktop" class="nav navbar-nav navbar-right">
			<li><a class="nav-link-espanol" href="inicio.php"><button class="btn btn-espanol">Español</button></a></li>
		</ul>
	...
	<div class="container-fluid no-padding">
		<div class="jumbotron">
			<div class="row text-center">
				...
				<div class="col-md-10">
					<!-- <img class="img-responsive jumbotron-img" alt="main img" src="img/mainimg.png" /> --><h1 id="jumbotron-text">Our law firm believes in and fights for the rights of immigrants</h1>
					<h3 class="jumbotron-text-color">Contact L.A. Rights Law Office today</h3>
					<a href="contact.php"><button class="btn btn-cta">CONTACT US</button></a>
					<p>Or <a class="jumbotron-link" href="about.html">read more</a> about our services</p>
				</div>
				<div class="col-md-1"></div>
			</div>
		</div>
		...
		<div class="row maincta-bg">
			<div class="container" id="maincta">
				...
				<div class="col-md-6 col-sm-6 ctatext">
					<h3 class="large-text">Our law firm provides affordable legal services because we believe that everybody deserves the right to a lawyer.</h3>
					<p class="maincta-text">Immigration matters can be difficult for the individual, family & friends. Often, immigrants who try to navigate the system without an attorney often face unnecessary delays, denial of their application or deportation.</p><br>
					<p class="maincta-text">At L.A. Rights Law Office in Los Angeles, California, our clients are treated with respect and dignity. Our lawyers will evaluate your situation, and offer sound, trustworthy advice.</p>
				</div>
				<div class="col-md-5 col-sm-6" id="schedule">
					<div class="text-center">
						<p class="schedule-an-appt-home">Schedule an appointment:</p>
					...
					<form id="ctaform" method="post" action="contact-form-index.php" onsubmit="validateForm();">
						<label>NAME</label><br>
